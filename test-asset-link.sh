...
test_validate-asset(){
    ...
    test_ok curl -fsSL -o "$TEST_PATH/iah_base.yaml" https://raw.githubusercontent.com/industrial-asset-hub/asset-link-sdk/feat/model-update-migration-doc/model/iah-base_v1.18.0.yaml
